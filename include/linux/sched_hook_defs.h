...
BPF_SCHED_HOOK(int, 0, cfs_sched_tick_end,struct rq *rq,u64 now_time,unsigned int num_of_idle,int curr_lock_depth,int curr_kernel_lockholder,int curr_user_lockholder,int curr_lockholder)
...
BPF_SCHED_HOOK(int, 0, cfs_latency_select,int prev,struct task_struct *curr,struct cpumask *idle_cpus,int average_capacity,int total_cpus)
